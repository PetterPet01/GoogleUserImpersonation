...
namespace CefSharp
{
    ...
    /// </summary>
    public static class LTPostDataExtensions
    {
        /// <summary>
        ...
        public static string GetCharSet(this LTRequest request)
        {
        ...
        public static string GetCharSet(this HttpContent content)
        {
            //Extract the Content-Type header value.
            ...
            {
                if (kvp.Key.Equals("content-type", StringComparison.InvariantCultureIgnoreCase))
                {
        ...
        public static string GetBody(this PostDataElement_ postDataElement, string charSet = null)
        {
